...
class DeleteWeight extends StatefulWidget {
  const DeleteWeight({Key? key}) : super(key: key);

  @override
  State<DeleteWeight> createState() => _State();
}

class _State extends State<DeleteWeight> {
  ...
  Future<void> _deleteData() async {
    ...
    final response = await http.post(Uri.parse("https://us-central1-loop-92fb2.cloudfunctions.net/api/delete_weight"),
      headers: {"Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"},
      body: <String, String>{
        "username": username,
        "timestamp": timestamp,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Click to Delete Weight'),
        centerTitle: true,
      ),
      drawer: MyDrawer(),
      body:  Center(
